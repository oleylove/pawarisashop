...
<div class="form-group {{ $errors->has('score_total') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="score_total" type="number" id="score_total"
        value="{{ isset($order->score_total) ? $order->score_total : ''}}">
...
<div class="form-group {{ $errors->has('status') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="status" type="text" id="status"
        value="{{ isset($order->status) ? $order->status : ''}}">
...
<div class="form-group {{ $errors->has('checking_at') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="checking_at" type="datetime-local" id="checking_at"
        value="{{ isset($order->checking_at) ? $order->checking_at : ''}}">
...
<div class="form-group {{ $errors->has('paid_at') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="paid_at" type="datetime-local" id="paid_at"
        value="{{ isset($order->paid_at) ? $order->paid_at : ''}}">
...
<div class="form-group {{ $errors->has('cancelled_at') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="cancelled_at" type="datetime-local" id="cancelled_at"
        value="{{ isset($order->cancelled_at) ? $order->cancelled_at : ''}}">
...
<div class="form-group {{ $errors->has('completed_at') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="completed_at" type="datetime-local" id="completed_at"
        value="{{ isset($order->completed_at) ? $order->completed_at : ''}}">
