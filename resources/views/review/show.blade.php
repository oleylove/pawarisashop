                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> User Id </th><td> {{ $review->user_id }} </td></tr><tr><th> Prod Id </th><td> {{ $review->prod_id }} </td></tr><tr><th> Vote Id </th><td> {{ $review->vote_id }} </td></tr><tr><th> Comment </th><td> {{ $review->comment }} </td></tr>
                                </tbody>
                            </table>
                        </div>
